                        ...
                        <div className="grid lg:grid-cols-12 gap-24">
                            ...
                            <div className="lg:col-span-7">
                                <div className="relative group">
                                    ...
                                    <div className="relative bg-white p-12 lg:p-16 rounded-2xl border border-navy-100 shadow-glass">
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        ...
                        <div className="grid md:grid-cols-3 gap-10">
                            {[
                                ...
                                <div key={i} className="group bg-white p-12 rounded-xl border border-navy-100 shadow-glass hover:shadow-premium transition-all duration-500 hover-lift relative overflow-hidden">
                                    ...
                                    <div className="w-20 h-20 bg-brand-blue-50 rounded-xl flex items-center justify-center mb-10 group-hover:bg-brand-blue-600 transition-all duration-500">
