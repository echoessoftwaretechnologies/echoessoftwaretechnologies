                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[
                                ...
                                { title: "AI Solutions", description: "Machine learning models to automate tasks and gain intelligence.", icon: "cpu" },
                                ...
                                <div key={index} className="group bg-white p-8 rounded-2xl border border-navy-100 shadow-glass hover:shadow-xl hover:shadow-brand-blue-500/20 hover-lift transition-all duration-500 flex flex-col h-full relative overflow-hidden">
                                    ...
                                    {/* Icon container */}
                                    <div className="w-16 h-16 bg-brand-blue-50/70 rounded-xl flex items-center justify-center mb-6 group-hover:bg-brand-blue-100 transition-all duration-500 shadow-sm mx-auto">
                                        <i data-lucide={service.icon} className="w-8 h-8 text-brand-blue-600 group-hover:text-brand-blue-700 transition-colors duration-500"></i>
                                    </div>
                                    
                                    {/* Content container */}
                                    <div className="flex-grow flex flex-col">
                                        <h3 className="text-xl font-black text-navy-950 mb-4 uppercase tracking-tight text-center group-hover:text-brand-blue-600 transition-colors">
                                            {service.title}
                                        </h3>
                                        <p className="text-navy-600 leading-relaxed mb-6 text-base font-light text-center flex-grow">
                                            {service.description}
                                        </p>
